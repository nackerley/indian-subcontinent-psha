...
%	hidelinks]{hyperref} % hyperlinks and autoref
% backref=page,
...
%\usepackage{tikz}
%\usetikzlibrary{graphs,shapes,arrows.meta,arrows.spaced,graphdrawing}
...
\begin{figure}
\includegraphics[width=0.5\textwidth]{figures1a.png}
\caption{Hazard map of India}
\label{figure_label}
\end{figure}
...
\begin{table}
\caption{Ground shaking intensity models. Models newly implemented in OpenQuake as part of the current work are indicated.}
\centering
\begin{tabular}{c c l}
\hline
 Code & New & Reference \\
